 ...
 */
__attribute__((always_inline)) RV_STATIC_INLINE void PFIC_EnableIRQ(
    IRQn_Type IRQn) {
 ...
 * @param   IRQn    - Interrupt Numbers
 */
__attribute__((always_inline)) RV_STATIC_INLINE void PFIC_DisableIRQ(
    IRQn_Type IRQn) {
 ...
 * @param   IRQn    - Interrupt Numbers
 */
__attribute__((always_inline)) RV_STATIC_INLINE void PFIC_SetPendingIRQ(
    IRQn_Type IRQn) {
 ...
 * @param   IRQn    - Interrupt Numbers
 */
__attribute__((always_inline)) RV_STATIC_INLINE void PFIC_ClearPendingIRQ(
    IRQn_Type IRQn) {
 ...
 */
__attribute__((always_inline)) RV_STATIC_INLINE void PFIC_SetPriority(
 ...
 * @return  none
 */
__attribute__((always_inline)) RV_STATIC_INLINE void __set_MSTATUS(
    uint32_t value) {
 ...
 * @return  none
 */
__attribute__((always_inline)) RV_STATIC_INLINE void __set_MISA(
    uint32_t value) {
 ...
 * @return  none
 */
__attribute__((always_inline)) RV_STATIC_INLINE void __set_MTVEC(
    uint32_t value) {
 ...
 * @return  none
 */
__attribute__((always_inline)) RV_STATIC_INLINE void __set_MSCRATCH(
    uint32_t value) {
 ...
 * @return  mepc value
 */
__attribute__((always_inline)) RV_STATIC_INLINE void __set_MEPC(
    uint32_t value) {
 ...
 * @return  mcause value
 */
__attribute__((always_inline)) RV_STATIC_INLINE void __set_MCAUSE(
    uint32_t value) {
 ...
 * @return  mtval value
 */
__attribute__((always_inline)) RV_STATIC_INLINE void __set_MTVAL(
    uint32_t value) {
